...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i>Telefonos Registrados</h3>
    ...
    <div class="row">
                        ...
                        <button id="boton_modificar" class="btn btn-info" data-toggle="modal" data-target="#myModal">
                            Modificar No Telefono
                        </button>
            
                        <button id="boton_eliminar"class="btn btn-info" type="button" id="mi_boton_eliminar">
                            Eliminar No Telefono
                        </button>     
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-header">
                                  ...
                                  <h4 class="modal-title selecion">Accion</h4>
                              </div>
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modalEliminar" class="modal fade">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-header">
                                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                  <h4 class="modal-title selecion"><strong>Eliminar No Telefonico</strong></h4>
                              </div>
                              <div class="modal-body">
                                 <center><p><strong>esta seguro de eliminar el No Telefonico ?</strong></p></center> 
