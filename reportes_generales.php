...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa fa-bars"></i><strong>Reportes Generales</strong></h3>
  ...
  table.columns().every(function () {
    ...
    $('#example tbody').on( 'click', 'tr', function () {
        if ( $(this).hasClass('selected') ) {
            window.location.href=table.row('.selected').data()[0]+'_reportes_generales.php';
