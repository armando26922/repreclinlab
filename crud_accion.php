...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa fa-bars"></i><strong>Acciones del Sistema</strong></h3>
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-header">
                                  ...
                                  <h4 class="modal-title selecion">Acciones</h4>
                              </div>
