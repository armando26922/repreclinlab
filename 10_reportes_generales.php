...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i> <strong>REPORTE GENERAL 10</strong></h3>
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  ...
                                  <input type="text" name="nombre_cargo" placeholder="*Cargo" autocomplete="off" class="form-control placeholder-no-fix">
                                  </br>
                                  <p><strong>Salario del Cargo</strong></p>
                                  <input type="number" name="salario_cargo" placeholder="*Monto" autocomplete="off" class="form-control placeholder-no-fix">  
                                </br>
