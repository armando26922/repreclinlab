      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<h3 class="page-header"><i class="fa fa-bars"></i></a><strong>Transferencia</strong></h3>
...
<div class="row">
        ...
        <table class="table table-bordered table-striped table-hover table-heading table-datatable"  id="example">
          ...
          <tbody>
                  <?php 
                    ...
                    $sql="SELECT fk_repuesto, fk_empleado,fk_empleado_1, cant_transferencia 
                          FROM transferencia";
                    $base_db->ejecutar($sql);
                      ...
                      while($valor=$base_db->obtener_fila($base_db->getCorrida(),0)) { 
                       ...
                       print("<td>".$valor['fk_empleado_1']."</td>");
                       print("<td>".$valor['fk_repuesto']."</td>");
                       print("<td>".$valor['cant_transferencia']."</td>");
 ...
 <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-header">
                                  ...
                                  <h4 class="modal-title selecion"><strong>TRANSFERENCIA</strong></h4>
                              </div>
                    ...
                    $base_db->ejecutar($sql);
                      ...
                      while($valor=$base_db->obtener_fila($base_db->getCorrida(),0)) { 
                      print("<option  value='".$valor['id_empleado']."'>".$valor['nombre_empleado']."</option>");
              ...
              ?>
                                  ...
                                  <select class="defaultw" id="id_empleado_2" >
                                      <?php 
              ...
              ?>
                    ...
                    $sql="SELECT codigo_parte_repuestos
                          FROM repuesto";
                    $base_db->ejecutar($sql);
                    
                   
                      while($valor=$base_db->obtener_fila($base_db->getCorrida(),0)) { 
                      print("<option  value='".$valor['codigo_parte_repuestos']."'>".$valor['codigo_parte_repuestos']."</option>");
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  ...
                                  <input type="text" id="id_tecnico_1_modificar" name="tecnico" placeholder="*tecnico" autocomplete="off" class="form-control placeholder-no-fix">
                                     <p><strong>Serial-Respuesto</strong></p>
  ...
  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modalEliminar" class="modal fade">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-header">
                                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                  <h4 class="modal-title selecion"><strong>Eliminar Transferencia</strong></h4>
                              </div>
                              <div class="modal-body">
                                 <center><p><strong>Esta seguro de eliminar la transferencia ?</strong></p></center> 
                              
                              </div>
                              <div class="modal-footer">
                              <div class="row">
                                  <div class="col-lg-2">
                                    <button data-dismiss="modal" id="boton_eliminar_final" class="btn btn-danger" type="button"><strong>Elimnar</strong></button>  
                                  </div>
                                  <div class="col-lg-8">
                                   </div> 
                                  <div class="col-lg-2">
...
$( "#id_repuesto" ).combobox();
 ...
 $.ajax({
   ...
   url: 'modificar_transferencia.php',
         type:"post",
          data: {     nombre_atributo:$('#id_tecnico_modificar').val(),
                      nombre_atributo2:$('#id_tecnico_1_modificar').val(),
                     nombre_atributo3:$('#id_serial_modificar').val(),
                     nombre_atributo4:$('#id_stock_modificar').val(),
   ...
   success:function(data,textStatus,jqXHR){
           ...
           alert(data);
          if(data=='error'){
                    alert('Error al modificar la transferencia ');
             }else{
...
function ajax_agregar(){
    $.ajax({
             ...
             data: {  
                     ...
                     nombre_atributo2:$('#id_empleado_2').val(),
                     nombre_atributo3:$('#id_repuesto').val(),
                     nombre_atributo4:$('#id_stock').val(),
...
function ajax_eliminar(){   ///// inicio de la funcion ajax_eliminar
  ...
  $.ajax({ //inicio ajax insertar
   ...
   url: 'eliminar_transferencia.php',
         type:"post",
   
     data: {  nombre_atributo:table.row('.selected').data()[0],
             nombre_atributo2:table.row('.selected').data()[1],
             nombre_atributo3:table.row('.selected').data()[2],
             nombre_atributo4:table.row('.selected').data()[3],  },
         success:function(data,textStatus,jqXHR){
...
$('#boton_modificar').click( function() {
  ...
  $("#id_tecnico_1_modificar").val(datos[1]);  
  $("#id_serial_modificar").val(datos[2]);
